...
import midPagePic from './midPagePic.jpg';
import homefurn from "./homefurn.jpg";
import officefurn from './officefurn.jpg';
import outdoorfurn from './outdoorfurn.jpg';
import SlideShowMobile from	'./SlideShowMobile/SlideShowMobile';
import SlideShow2Mobile from './SlideShow2Mobile/SlideShow2Mobile';
...
function Home() {
  return (
    <div  >
    	<div className="sale-banner-desktop-only">
    		<div className="flex items-center justify-center pa2 bg-dark-pink ">
			  
			  <span className=" pr3 fw8 white" style={{"font-size":"45px","font-family":"Open Sans" }}> WEEKEND SALE  </span>
			  <span className="black fw8" style={{"font-size":"45px","font-family":"Open Sans" }}> ON NOW! </span>
			</div>
    	</div>

    	<div className='sale-banner-mobile-only'>
    		<div className="items-center justify-center pa2 bg-dark-pink ">
			  
			  <span className=" pr3 fw8 white" style={{"font-size":"40px","font-family":"Open Sans" }}> WEEKEND SALE  </span>
			  <span className="black fw8" style={{"font-size":"40px","font-family":"Open Sans" }}> ON NOW! </span>
			</div>
    	</div>
		...
		<article className=" pb5">
		  <header className="vh-100 bg-light-pink dt w-100">
		    ...
		    style ={ { backgroundImage: "url("+banner+")" }}
		      ...
		      className="dtc v-top cover ">
		      <div className="mt4 " style={{"background-color":"rgba(255, 255, 255, 0.8)", "width":"34%", }}>
			      <h1  className=" pv0 mv0 measure lh-solid fw9 black courier  " style={{"font-size":"35px" }}>up to </h1>
			      <h1 className=" pv0 mv0 measure lh-solid fw9 dark-pink baskerville " style={{"font-size":"60px", }}>30% OFF </h1>
			      <h1 className=" pv0 mv0 measure lh-solid fw9 black courier tracked-tight" style={{"font-size":"35px" }} > FURNITURE, DECOR + MORE</h1>
	     ...
	     <div className="sale-banner-mobile-only">
			<article className=" pb5">
			  <header className="vh-100 bg-light-pink dt w-100">
			    <div 
			    style ={ { backgroundImage: "url("+banner+")", "height":"50%" }}
			      
			      className="dtc v-top cover  ">
			      <div className="mt4 " style={{"background-color":"rgba(255, 255, 255, 0.8)", "width":"34%", }}>
				      <h1  className=" pv0 mv0 measure lh-solid fw9 black courier  " style={{"font-size":"20px" }}>up to </h1>
				      <h1 className=" pv0 mv0 measure lh-solid fw9 dark-pink baskerville " style={{"font-size":"45px", }}>30% OFF </h1>
				      <h1 className=" pv0 mv0 measure lh-solid fw9 black courier tracked-tight" style={{"font-size":"20px" }} > FURNITURE, DECOR + MORE</h1>
	   	...
	   	<div className='sale-banner-desktop-only center' style={{"width":"94%", }}>
	   		<SlideShow />
	   	</div>

	   	<div className='sale-banner-mobile-only center' style={{"width":"92%", }}>
	   		<SlideShowMobile />
	   	</div>
	   	...
	   	<div className='mv4 '>
	   		<div className ='pv4 '>
	   			<section class=" center Krasse-on-mobile"  style={{"width":"95%", }}>
				  
				  <article class="pv4 ph3 ph0-l">
				    <div class="flex flex-column flex-row-ns">
				      <div class="w-100 w-20-ns pr3-ns order-2 order-1-ns">
				        <h1 class="f3 athelas mt0 lh-title  bt pv4 b--black-10 heading-on-mobile">LUSHROOM x Kat Krasse</h1>
				        <p class="f5 f4-l lh-copy athelas paragraph-on-mobile">
				          Introducing Kat Krass - a Sonlokia based illustrator known for her abstract patterns, organic shapes and earthy colour palettes.
				          We teamed up with the artist to create a collection of must-have accessories, from wall art to textiles. Dreamy.
				        </p>
				      </div>
				      <div class="pl3-ns order-1 order-2-ns mb4 mb0-ns w-100 w-80-ns">
				        <img src={midPagePic} width="100%" class="db" alt="A dimly lit room with a computer interface terminal."/>
				      </div>
				    </div>
	   	...
	   	<div className='sale-banner-mobile-only  center' style={{"width":"94%", }}>
	   		<SlideShow2Mobile/>
	   	</div>
	   	...
	   	<div className=" mv4 pv4 sale-banner-desktop-only  ">
		   	<div>
		   		<h2 className='tl f2 baskerville  pl4'> Shop By Room</h2>
		   		<div  className='ph3' >
		   			<div  className=' flex ' > 


						<div className='pa1'>
							<Link to='/home-furniture' className='pointer no-underline'>
							<p  className="link  pointer dt  br2 cover bg-center" 
							style ={ { backgroundImage: "url("+homefurn+")" ,
						...
						<div className='pa1'>
							<Link to='/office-furniture' className='pointer no-underline'>
							<p className="link pointer dt  br2 cover bg-center" 
							style ={ { backgroundImage: "url("+officefurn+")" ,
								'width':'430px', 'height':'400px'
							}} >
							  <span className="white  dtc v-btm w-100 h-100 child  tc bg-black-20">
						...
						<div className='pa1'>
							<Link to='/outdoor-furniture' className='pointer no-underline'>
							<p  className="link pointer dt  br2 cover bg-center" 
							style ={ { backgroundImage: "url("+outdoorfurn+")" ,
								'width':'430px', 'height':'400px'
							}} >
							  <span className="white  dtc v-btm w-100 h-100 child  tc bg-black-20">
	   	...
	   	<div className=" mv4 pv4 sale-banner-mobile-only ">
		   	<div>
		   		<h2 className='tl heading-on-mobile baskerville  center ph2'> Shop By Room  </h2>
		   		<div  className='' >
		   			<div  className=' ' > 
