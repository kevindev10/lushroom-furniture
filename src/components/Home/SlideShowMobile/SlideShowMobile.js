...
export default class Responsive extends React.Component {
  ...
  return (
      <div>
        <h2 className='tl heading-on-mobile baskerville pb0'> Our Fave Finds</h2>
        <Slider {...settings}>
          <div>
            <h3 className=''> <img src={sliderImg1}  width="100%" height='400px'   alt=""/>
                <div className='flex'>
          ...
          <div>
            <h3> <img src={sliderImg2}  width="100%" height='400px'   alt=""/> 
                <div className='flex'>
                   <div class="w-50 w-50-l ">
          ...
          <div>
            <h3> <img src={sliderImg6}  width="100%" height='400px'   alt=""/>
               <div className='flex'>
                   <div class="w-50 w-50-l ">
          ...
          <div>
            <h3> <img src={sliderImg8}  width="100%" height='400px'   alt=""/>
               <div className='flex'>
                   <div class="w-50 w-50-l ">
