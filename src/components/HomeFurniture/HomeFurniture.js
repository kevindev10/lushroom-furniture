...
function HomeFurniture() {
  return (
    <div  >
    	...
    	<div>
    		<h1 className='baskerville tracked giant-logo-on-mobile ' style={{'font-size':'50px'}}>Home Furniture </h1>
       </div>
       ...
       <div className='bb b--black-20 center  top-menu-desktop-only ' style={{'width':'96%'}}>
    		<div className='flex mh6 ph7 pv0'>
    			<section class="tc pa4   ">
    				<Link to='/living-room' className='no-underline link pointer'>
			  		<article class=" mw4 center ">
				    <img src={livingRoom} height="81px"  class=" mw4 " alt="executive desk" />
				    <div class="pa2 ">
				      <p class="f6 db link  black" href="#">Living Room</p>
				    </div>
			    	</article>
			    	</Link>
				</section>
				...
				<section class="tc  pa4 ">
					<Link to='/dining-room' className='no-underline link pointer'>
			  		<article class="  mw4 center ">
				    <img src={diningRoom} height="81px"  class=" mw4 " alt="executive desk" />
				    <div class="pa2 ">
				      <p class="f6 db link  black" href="#">Dining Room</p>
				    </div>
			    	</article>
			    	</Link>
				</section>
				...
				<section class="tc pa4  ">
					<Link to='/bedroom' className='no-underline link pointer'>
			  		<article class="  mw4 center ">
				    <img src={bedroom} height="81px" class="  mw4 " alt="executive desk" style={{"object-fit": "cover"}}/>
				    <div class="pa2 ">
				      <p class="f6 db link  black" href="#">Bedroom</p>
				    </div>
			    	</article>
			    	</Link>
				</section>
    	...
    	<div className='pv3 mv3 '>
    		<div>
    			<h1 className=' ml2 pl4 tl f2 dim'><Link to='/living-room' className='no-underline link pointer black baskerville'>Living Room</Link></h1>
    			<div className='flex mh4   off-furn-pic-row-on-mobile '>
    				...
    				<Link to='/living-room' className='no-underline link pointer black'>
					  <img src={livingRoom1} height='450px' width='450px'  class="db  br2 br--top    off-furn-pic-row-on-mobile-img " alt=" kitten looking menacing." style={{"object-fit": "cover"}}/>
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					        <h1 class="f6 f6-ns mv0 tl fw1">Five Seater Sofa Set with Coffee Table </h1>
					      </div>
					      <div class="dtc tr">
					        <h2 class="f6 mv0 fw1">$1499</h2>
					      </div>
					    </div>
					   </div>
					  </Link>
					...
					<Link to='/living-room' className='no-underline link pointer black'>
					  <img src={livingRoom2} height='450px' width='450px'   class="db  br2 br--top  off-furn-pic-row-on-mobile-img" alt="kitten looking menacing."/>
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					        <h1 class="f6 f6-ns mv0 fw1 tl">Four velvet Seater Sofa Set</h1>
					      </div>
					      <div class="dtc tr">
					        <h2 class="f6 mv0 fw1">$899</h2>
					      </div>
					    </div>
					...
					<article class="br2  mv4 ph2 center off-furn-pic-row-on-mobile-article">
						<Link to='/living-room' className='no-underline link pointer black'>
					  <img src={livingRoom3} height='450px' width='450px'   class="db  br2 br--top  off-furn-pic-row-on-mobile-img" alt=" looking menacing." style={{"object-fit": "cover"}}/>
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					        <h1 class="f6 f6-ns mv0 fw1 tl">Five Seater Sofa Set with Coffee Table	</h1>
					      </div>
					      <div class="dtc tr">
					        <h2 class="f6 mv0 fw1">$1299</h2>
					      </div>
					    </div>
        ...
        <div className='pv3 mv3 '>
    		<div>
    			<h1 className=' ml2 pl4 tl f2 dim'><Link to='/dining-room' className='no-underline link pointer black baskerville'>Dining Room</Link></h1>
    			<div className='flex mh4  off-furn-pic-row-on-mobile'>
    				<article class="br2  mv4 ph2 center off-furn-pic-row-on-mobile-article">
    				<Link to='/dining-room' className='no-underline link pointer black'>
					  <img src={diningRoom1} height='450px' width='450px'  class="db  br2 br--top  off-furn-pic-row-on-mobile-img" alt=" kitten looking menacing." style={{"object-fit": "cover"}} />
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					        <h1 class="f6 f6-ns mv0 tl fw1"> Bullard Dining Room Furniture</h1>
					      </div>
					      <div class="dtc tr">
					...
					<article class="br2 mv4 ph2 center">
					<Link to='/dining-room' className='no-underline link pointer black'>
					  <img src={diningRoom2} height='450px' width='450px'  class="db  br2 br--top  off-furn-pic-row-on-mobile-img" alt=" kitten looking menacing." style={{"object-fit": "cover"}} />
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					        <h1 class="f6 f6-ns mv0 fw1 tl">Weston Espresso 6 Piece Dining Table Set</h1>
					      </div>
					      <div class="dtc tr">
					...
					<article class="br2  mv4 ph2 center off-furn-pic-row-on-mobile-article">
						<Link to='/dining-room' className='no-underline link pointer black'>
					  <img src={diningRoom3} height='450px' width='450px'  class="db  br2 br--top  off-furn-pic-row-on-mobile-img" alt=" kitten looking menacing." style={{"object-fit": "cover"}} />
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					        <h1 class="f6 f6-ns mv0 fw1 tl">Casablanca Dining Room with Rex bedroom	</h1>
					      </div>
					      <div class="dtc tr">
    	...
    	<div className='pv3 mv3 '>
    		<div>
    			<h1 className=' ml2 pl4 tl f2 dim'><Link to='/bedroom' className='no-underline link pointer black baskerville'>Bedroom</Link></h1>
    			<div className='flex mh4  off-furn-pic-row-on-mobile'>
    				<article class="br2  mv4 ph2 center off-furn-pic-row-on-mobile-article">
    				<Link to='/bedroom' className='no-underline link pointer black'>
					  <img src={bedroom1} height='450px' width='450px'  class="db  br2 br--top  off-furn-pic-row-on-mobile-img" alt="kitten looking menacing." style={{"object-fit": "cover"}}/>
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					...
					<article class="br2 mv4 ph2 center">
					<Link to='/bedroom' className='no-underline link pointer black'>
					  <img src={bedroom2} height='450px' width='450px'  class="db  br2 br--top  off-furn-pic-row-on-mobile-img" alt=" kitten looking menacing." style={{"object-fit": "cover"}}/>
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					        <h1 class="f6 f6-ns mv0 fw1 tl">Micah Black LED Bedroom Furniture Sets </h1>
					      </div>
					      <div class="dtc tr">
					...
					<article class="br2  mv4 ph2 center off-furn-pic-row-on-mobile-article">
						<Link to='/bedroom' className='no-underline link pointer black'>
					  <img src={bedroom3} height='450px' width='450px'  class="db  br2 br--top  off-furn-pic-row-on-mobile-img" alt=" kitten looking menacing."  style={{"object-fit": "cover"}}/>
					  <div class="pa2 ph3-ns pb3-ns">
					    <div class="dt w-100 mt1">
					      <div class="dtc">
					        <h1 class="f6 f6-ns mv0 fw1 tl">Myer 5PCE White Single Bedroom Suite | Storage	</h1>
					      </div>
					      <div class="dtc tr">
					        <h2 class="f6 mv0 fw1">$999</h2>
					      </div>
					    </div>
